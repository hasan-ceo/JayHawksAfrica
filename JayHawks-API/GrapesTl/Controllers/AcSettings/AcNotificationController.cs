...
[ApiController]
public class AcNotificationController(IUnitOfWork unitOfWork) : ControllerBase
{
    ...
    public async Task<IActionResult> ListByUser()
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.List<NotificationView>("acNotificationGetByUser", parameter);
