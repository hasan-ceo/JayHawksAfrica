...
namespace GrapesTl.Controllers
{
    ...
    [ApiController]
    public class AcTrialBalanceController(IUnitOfWork unitOfWork) : ControllerBase
    {
        ...
        public async Task<IActionResult> List()
        {
            try
            {
                var data = await _unitOfWork.SP_Call.List<AccountGlView>("ActGLTrialBalanceGetAll");
