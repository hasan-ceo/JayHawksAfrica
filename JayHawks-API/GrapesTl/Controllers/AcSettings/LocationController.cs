...
public class LocationController(IUnitOfWork unitOfWork) : ControllerBase
{
    ...
    public async Task<IActionResult> List()
    {
        try
        {
            var data = await _unitOfWork.SP_Call.List<Location>("acLocationGetAll");
    ...
    public async Task<IActionResult> Select()
    {
        ...
        {
            var data = await _unitOfWork.SP_Call.List<Location>("acLocationGetAll");
            return Ok(data.Select(a => new { listId = a.LocationId, listName = a.LocationName }));
        }
        catch (Exception e)
        {
            return StatusCode(StatusCodes.Status500InternalServerError,
    ...
    public async Task<IActionResult> Details(string id)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.OneRecord<Location>("acLocationGetById", parameter);
    ...
    public async Task<IActionResult> Create([FromBody] Location model)
    {
        ...
        try
        {
            ...
            await _unitOfWork.SP_Call.Execute("acLocationCreate", parameter);
    ...
    public async Task<IActionResult> Update([FromBody] Location model)
    {
        ...
        try
        {
            ...
            parameter.Add("@Message", "", dbType: DbType.String, direction: ParameterDirection.Output);
            await _unitOfWork.SP_Call.Execute("acLocationUpdate", parameter);
            var message = parameter.Get<string>("Message");
    ...
    public async Task<IActionResult> Delete(string id)
    {
        try
        {
            ...
            parameter.Add("@Message", "", dbType: DbType.String, direction: ParameterDirection.Output);
            await _unitOfWork.SP_Call.Execute("acLocationDelete", parameter);
