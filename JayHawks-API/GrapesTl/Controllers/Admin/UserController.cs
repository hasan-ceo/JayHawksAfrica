        ...
        public async Task<IActionResult> CreateAll()
        {
            try
            {
                ...
                foreach (var item in data)
                {
                    ...
                    //var role = item.DesignationName == "Regional Manager" ? "Regional Manager" : item.DesignationName == "Area Manager" ? "Area Manager" : item.DesignationName == "Branch Manager" ? "Branch Manager" : "";
                    var result = await _authService.RegisterUserAsync(model, SD.Role_User);
