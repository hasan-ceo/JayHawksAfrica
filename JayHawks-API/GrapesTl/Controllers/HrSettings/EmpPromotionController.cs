...
[ApiController]
public class EmpPromotionController(IUnitOfWork unitOfWork) : ControllerBase
{
    ...
    [HttpPost("Create")]
    public async Task<IActionResult> Create([FromForm] EmpPromotion model)
    {
        ...
        try
        {
            ...
            await _unitOfWork.SP_Call.Execute("hrEmpPromotionCreate", parameter);
