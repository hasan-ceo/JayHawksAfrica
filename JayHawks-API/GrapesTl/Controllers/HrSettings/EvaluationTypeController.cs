...
[ApiController]
public class EvaluationTypeController(IUnitOfWork unitOfWork) : ControllerBase
{
    ...
    public async Task<IActionResult> Create([FromBody] EvaluationType model)
    {
        ...
        try
        {
            ...
            parameter.Add("@Frequency", model.Frequency);
    ...
    public async Task<IActionResult> Delete(string id)
    {
        try
        {
            ...
            parameter.Add("@Message", "", dbType: DbType.String, direction: ParameterDirection.Output);
            await _unitOfWork.SP_Call.Execute("hrEvaluationTypeDelete", parameter);
