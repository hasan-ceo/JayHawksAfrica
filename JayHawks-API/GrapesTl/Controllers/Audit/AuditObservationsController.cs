...
[ApiController]
public class AuditObservationsController(IUnitOfWork unitOfWork) : ControllerBase
{
    ...
    public async Task<IActionResult> Create([FromForm] AuditObservations model)
    {
        ...
        try
        {
            ...
            parameter.Add("@Details", OperationConstant.AuditObservationsCreate);
    ...
    [Authorize(Roles = "Super Admin,Audit Manager,Audit Executive")]
    [HttpPost("Update")]
    public async Task<IActionResult> Update([FromForm] AuditObservations model)
    {
        if (!ModelState.IsValid)
            return BadRequest(SD.Message_Model_Error);
        ...
        try
        {
            ...
            var parameter = new DynamicParameters();
            parameter.Add("@ObservationsId", model.ObservationssId);
            parameter.Add("@AuditId", model.AuditId);
            parameter.Add("@AuditArea", model.AuditArea);
            parameter.Add("@Details", model.Details);
            parameter.Add("@RootCause", model.RootCause);
            ...
            parameter.Add("@Recommendations", model.Recommendations);
            parameter.Add("@Attachment", model.Attachment);
            parameter.Add("@Details", OperationConstant.AuditObservationsUpdate);
            parameter.Add("@OperationBy", _userId);

            parameter.Add("@Message", "", dbType: DbType.String, direction: ParameterDirection.Output);
            await _unitOfWork.SP_Call.Execute("AuditObservationsUpdate", parameter);
    ...
    public async Task<IActionResult> Delete(string id)
    {
        try
        {
            ...
            var parameter = new DynamicParameters();
            parameter.Add("@ObservationsId", id);
            parameter.Add("@Details", OperationConstant.AuditObservationsDelete);
            parameter.Add("@OperationBy", _userId);
