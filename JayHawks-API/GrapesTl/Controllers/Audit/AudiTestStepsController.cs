...
[ApiController]
public class AudiTestStepsController(IUnitOfWork unitOfWork) : ControllerBase
{
    ...
    public async Task<IActionResult> List(string id)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.List<AuditTestSteps>("AudiTestStepsGetByAudiTestStepsId", parameter);
    ...
    public async Task<IActionResult> Details(string id)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.OneRecord<AuditTestSteps>("AudiTestStepsGetById", parameter);
    ...
    [Authorize(Roles = "Super Admin,Audit Manager,Audit Executive")]
    [HttpPost("Update")]
    public async Task<IActionResult> Update([FromForm] AuditTestSteps model)
    {
        if (!ModelState.IsValid)
            return BadRequest(SD.Message_Model_Error);
        ...
        try
        {
            ...
            parameter.Add("@Message", "", dbType: DbType.String, direction: ParameterDirection.Output);
            await _unitOfWork.SP_Call.Execute("AudiTestStepsUpdate", parameter);
