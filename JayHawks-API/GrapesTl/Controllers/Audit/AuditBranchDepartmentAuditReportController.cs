...
public class AuditBranchDepartmentAuditReportController(IUnitOfWork unitOfWork) : ControllerBase
{
    ...
    public async Task<IActionResult> List()
    {
        try
        {
            var data = await _unitOfWork.SP_Call.List<BranchDepartmentAuditReport>("AuditDepartmentReportGetAll");
    ...
    public async Task<IActionResult> Details(string id)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.OneRecord<BranchDepartmentAuditReport>("AuditDepartmentReportGetById", parameter);
    ...
    [Authorize(Roles = "Super Admin,Audit Manager,Audit Executive")]
    [HttpPost("Create")]
    public async Task<IActionResult> Create([FromForm] BranchDepartmentAuditReport model)
    {
        ...
        try
        {
            ...
            parameter.Add("@AreaOfreview", model.AreaOfreview);
            ...
            parameter.Add("@Appendices", model.Appendices);

            parameter.Add("@Message", "", dbType: DbType.String, direction: ParameterDirection.Output);
            await _unitOfWork.SP_Call.Execute("AuditDepartmentReportCreate", parameter);
    ...
    [Authorize(Roles = "Super Admin,Audit Manager,Audit Executive")]
    [HttpPost("Update")]
    public async Task<IActionResult> Update([FromForm] BranchDepartmentAuditReport model)
    {
        if (!ModelState.IsValid)
            return BadRequest(SD.Message_Model_Error);
