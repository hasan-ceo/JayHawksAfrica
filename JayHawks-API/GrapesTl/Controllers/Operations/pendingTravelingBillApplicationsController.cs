...
[ApiController]
public class PendingTravelingBillApplicationsController(IUnitOfWork unitOfWork, IMailSender mailSender, ILogger<PendingAdvanceApplicationsController> logger) : ControllerBase
{
