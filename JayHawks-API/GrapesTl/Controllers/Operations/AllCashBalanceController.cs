...
[ApiController]
public class AllCashBalanceController(IUnitOfWork unitOfWork) : ControllerBase
{
    ...
    public async Task<IActionResult> List(string id)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.List<AllCashBalanceList>("OpsAllCashBalanceListGetAll", parameter);
    ...
    public async Task<IActionResult> CashBalanceList(string id)
    {
        try
        {
            var parameter = new DynamicParameters();
            parameter.Add("@AllVisitId", id);
            var data = await _unitOfWork.SP_Call.OneRecord<AllCashBalance>("OpsAllCashBalanceGetAll", parameter);
    ...
    public async Task<IActionResult> DetailsComments(string id)
    {
        try
        {
            ...
            var parameter = new DynamicParameters();
            parameter.Add("@CashBalanceId", id);

            var data = await _unitOfWork.SP_Call.OneRecord<AllCashBalance>("OpsAllCashBalanceGetById", parameter);
    ...
    public async Task<IActionResult> Details(string id)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.OneRecord<AllCashBalanceList>("OpsAllCashBalanceListGetById", parameter);
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update([FromBody] AllCashBalanceList model)
    {
        if (!ModelState.IsValid)
            return BadRequest(SD.Message_Model_Error);
        ...
        {
            var parameter = new DynamicParameters();
            parameter.Add("@CashBalanceId", model.CashBalanceId);
            ...
            parameter.Add("@Message", "", dbType: DbType.String, direction: ParameterDirection.Output);
            await _unitOfWork.SP_Call.Execute("OpsAllCashBalanceUpdate", parameter);
            var message = parameter.Get<string>("Message");
    ...
    public async Task<IActionResult> UpdateComments([FromBody] AllCashBalance model)
    {
        if (!ModelState.IsValid)
            return BadRequest(SD.Message_Model_Error);
        ...
        {
            var parameter = new DynamicParameters();
            parameter.Add("@AllCashBalanceId", model.CashBalanceId);
            parameter.Add("@IdentifiedMajor", model.IdentifiedMajor);
            parameter.Add("@TakenSteps", model.TakenSteps);
    ...
    [HttpPost("UpdateByBm")]
    public async Task<IActionResult> UpdateByBm([FromBody] AllCashBalance model)
    {
        if (!ModelState.IsValid)
            return BadRequest(SD.Message_Model_Error);
        ...
        try
        {
            ...
            parameter.Add("@Message", "", dbType: DbType.String, direction: ParameterDirection.Output);
            await _unitOfWork.SP_Call.Execute("OpsAllCashBalanceUpdateByBm", parameter);
            var message = parameter.Get<string>("Message");
    ...
    public async Task<IActionResult> UpdateBySupervisor([FromBody] AllCashBalance model)
    {
        if (!ModelState.IsValid)
            return BadRequest(SD.Message_Model_Error);
        ...
        try
        {
            ...
            parameter.Add("@Message", "", dbType: DbType.String, direction: ParameterDirection.Output);
            await _unitOfWork.SP_Call.Execute("OpsAllCashBalanceUpdateByManager", parameter);
            var message = parameter.Get<string>("Message");
