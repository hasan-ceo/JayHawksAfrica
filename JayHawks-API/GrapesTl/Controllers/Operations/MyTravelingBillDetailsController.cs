...
[ApiController]
public class MyTravelingBillDetailsController(IUnitOfWork unitOfWork) : ControllerBase
{
    ...
    public async Task<IActionResult> Create([FromForm] TravelingBill model)
    {
        ...
        try
        {
            ...
            await _unitOfWork.SP_Call.Execute("OpsTravelingBillDetailsCreate", parameter);
    ...
    public async Task<IActionResult> List(string id)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.List<TravelingBill>("OpsTravelingBillDetailsGetById", parameter);
    ...
    public async Task<IActionResult> Details(string id)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.OneRecord<TravelingBill>("OpsTravelingBillDetailsGetByTravelBillId", parameter);
    ...
    public async Task<IActionResult> Update([FromForm] TravelingBill model)
    {
        ...
        try
        {
            ...
            parameter.Add("@Message", "", dbType: DbType.String, direction: ParameterDirection.Output);
            await _unitOfWork.SP_Call.Execute("OpsTravelingBillDetailsUpdate", parameter);
            var message = parameter.Get<string>("Message");
    ...
    public async Task<IActionResult> Delete(string id)
    {
        try
        {
            ...
            parameter.Add("@Message", "", dbType: DbType.String, direction: ParameterDirection.Output);
            await _unitOfWork.SP_Call.Execute("OpsTravelingBillDetailsDelete", parameter);
