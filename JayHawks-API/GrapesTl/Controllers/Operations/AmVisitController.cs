...
[ApiController]
public class AmVisitController(IUnitOfWork unitOfWork) : ControllerBase
{
    ...
    public async Task<IActionResult> ListByUser([FromRoute] DateTime fromDate, [FromRoute] DateTime tillDate)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.List<AmVisitView>("OpsAmVisitGetByUser", parameter);
    ...
    public async Task<IActionResult> ListByManager([FromRoute] DateTime fromDate, [FromRoute] DateTime tillDate)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.List<AmVisitView>("OpsVisitGetByManager", parameter);
    ...
    public async Task<IActionResult> DetailsById(string id)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.OneRecord<AmVisit>("OpsVisitGetDetailsById", parameter);
    ...
    public async Task<IActionResult> DetailsView(string id)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.OneRecord<AmVisitView>("OpsAmVisitViewGetById", parameter);
    ...
    public async Task<IActionResult> Details(string id)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.OneRecord<AmVisit>("OpsAmVisitGetById", parameter);
    ...
    //[Authorize(Roles = "Super Admin, Regional Manager,Area Manager")]
    [HttpPost("Create")]
    public async Task<IActionResult> Create([FromForm] AmVisit model)
    {
        ...
        try
        {
            ...
            await _unitOfWork.SP_Call.Execute("OpsAmVisitCreate", parameter);
    ...
    //[Authorize(Roles = "Super Admin, Regional Manager,Area Manager")]
    [HttpPost("Update")]
    public async Task<IActionResult> Update([FromForm] AmVisit model)
    {
        if (!ModelState.IsValid)
            return BadRequest(SD.Message_Model_Error);
        ...
        try
        {
            ...
            parameter.Add("@ManagerId", model.ManagerId);
            parameter.Add("@Message", "", dbType: DbType.String, direction: ParameterDirection.Output);
            await _unitOfWork.SP_Call.Execute("OpsAmVisitUpdate", parameter);
            var message = parameter.Get<string>("Message");
    ...
    //[Authorize(Roles = "Super Admin, Regional Manager,Area Manager")]
    [HttpPost("Submit")]
    public async Task<IActionResult> Submit([FromForm] AmVisitView model)
    {
        if (!ModelState.IsValid)
            return BadRequest(SD.Message_Model_Error);
        ...
        try
        {
            ...
            parameter.Add("@Message", "", dbType: DbType.String, direction: ParameterDirection.Output);
            await _unitOfWork.SP_Call.Execute("OpsAmVisitSubmit", parameter);
            var message = parameter.Get<string>("Message");
    ...
    public async Task<IActionResult> Delete(string id)
    {
        try
        {
            ...
            parameter.Add("@Message", "", dbType: DbType.String, direction: ParameterDirection.Output);
            await _unitOfWork.SP_Call.Execute("OpsAmVisitDelete", parameter);
