...
const hrRoutes = (
  <Route path="/*" element={<PrivateRoute />}>
    <Route element={<Layout />}>
      ...
      />
      {/* <Route path="hr/training/course/list" element={<ModHr.CourseList />} />
      <Route path="hr/training/course/add" element={<ModHr.CourseAdd />} />
      <Route
        path="hr/training/course/edit/:id"
        element={<ModHr.CourseEdit />}
      /> */}
