...
const EmployeeNewList = ({ dataForm }) => {
  ...
  return (
    <>
      {/* <PrintHeader title="" fileName="newjoin.csv" data={data} /> */}
      <div className="flex justify-end items-center">
        <PdfButton
          path={`/HrPdfReport/new/${dataForm.fromDate}/${dataForm.tillDate}`}
        />
        <PrintHeader
          title=""
            ...
            >
              ...
              <div className="flex justify-end space-x-2">
                <PdfButton
                  ...
                  path={`/HrPdfReport/JoiningLetter/${item.employeeId}`}
