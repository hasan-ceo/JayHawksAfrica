...
const PaymentVoucherList = () => {
  const {
    ...
    isError,
    refetch,
  } = useGetData("paymentVoucher", "/accountGl/paymentList");
    ...
    <div className="card w-full max-w-screen-xl">
      <div className="flex justify-between px-0 py-2 items-center">
        ...
        <div className="flex justify-end space-x-2">
          <TextButton path="/ac/paymentVoucher/byBank" title="By Bank" />
          <TextButton path="/ac/paymentVoucher/byCash" title="By Cash" />
        </div>
      </div>
