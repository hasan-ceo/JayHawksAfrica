...
const BmReviewList = () => {
  ...
  const {
    ...
    isError,
    // refetch,
  } = useGetData("visitbybm", `/allVisit/listByBranchManager`);
  ...
  return (
    <div className="card w-full max-w-screen-xl">
      <TopHeader
        title="Application Received As BM"
        btn="Return"
        path="/ops/visit"
      />
      <div className="flex justify-end items-center">
        <PdfButton path="/opsPdf/listByBranchManager" />
        <PrintHeader fileName="visitReceivedAsBmlist.csv" data={data} />
      </div>
                ...
                <div>
                  <div>
                    <div className="text-base text-primary">
                      <p>
                        ...
                        {item.employeeName} -{item.designationName}
                      </p>
                      <p>
                  ...
                  <div className="pt-2 flex justify-end space-x-2">
                    ...
                    <button
                      ...
                      onClick={() =>
                        navigate(
                          `${`/ops/visit/doc/bm/preview/list/${item.allVisitId}`}`
                        )
                      }
                    >
                    ...
                    <button
                      ...
                      onClick={() =>
                        navigate(
                          `${`/ops/bm/travelbill/list/${item.allVisitId}`}`
                        )
                      }
                    >
