...
import AuditWorkListForm from "./AuditWorkListForm";

const AuditWorkListEdit = () => {
  const { id } = useParams();
  const {
    data: list,
    error,
  ...
  return (
    <div className="card w-full max-w-screen-xl">
      <TopHeader
        title="Edit Audit Summary"
        btn="Return"
        path="/audit/summary/list"
      />
      <AuditWorkListForm
        defaultValues={{
        ...
        returnPath="/audit/summary/list"
      />
    </div>
  );
};

export default AuditWorkListEdit;
