            ...
            >
              ...
              <div>
                <div className="flex justify-end space-x-2">
                  {item.attachment && (
                    <AttachmentButton path={item.attachment} />
                  )}
                  <EditButton
                    path={`/audit/observations/edit/${item.observationsId}`}
                  />
                  <DeleteButton
                    action={refetch}
                    path={`/auditObservations/delete/${item.observationsId}`}
                  />
                </div>
              </div>
            </div>
