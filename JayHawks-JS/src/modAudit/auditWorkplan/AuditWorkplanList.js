...
const AuditWorkplanList = () => {
  const {
    ...
    isError,
    refetch,
  } = useGetData("auditworkplan", "/auditWorkplan/list");
          ...
          list.data.map((item, index) => (
            <div key={index} className="grid grid-cols-1 gap-2 list-body">
              <div className="grid grid-cols-1 md:grid-cols-12">
                ...
                <ListCol label="Audit Entiry :" value={item.branchName} />
                <ListCol label="Risk Rating :" value={item.riskRating} />
...
export default AuditWorkplanList;
