...
const EmployeePromotionList = ({ dataForm }) => {
  ...
  const {
    ...
    "emppromotionlist",
    `/hrreports/promotion/${dataForm.fromDate}/${dataForm.tillDate}`
  );
  ...
  return (
    <>
      {/* <PrintHeader title="" fileName="promotion.csv" data={data} /> */}
      <div className="flex justify-end items-center">
        <PdfButton
          path={`/HrPdfReport/promotion/${dataForm.fromDate}/${dataForm.tillDate}`}
        />
        <PrintHeader
          title=""
              ...
              <ListCol
                ...
                value={
                  item.preGrossSalaryUsd > 0
                    ...
                    : item.preGrossSalary.toLocaleString("en-US") + " Ugx"
                }
